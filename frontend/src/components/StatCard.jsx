...
const StatCard = ({ title, value, unit, icon, trend, isUp, delay }) => (
  <motion.div
    ...
    className="relative p-6 rounded-3xl bg-white/3 border border-white/5 backdrop-blur-xl hover:bg-white/5 transition-all duration-300 group overflow-hidden"
  >
    ...
    <div className="flex justify-between items-start mb-4">
      <div className="p-3 rounded-2xl bg-black/40 border border-white/5 text-[#7b1779]">
        {icon}
      </div>
